...
const YOUTUBE_URN = 'urn:x-cast:com.sailviz'

class CustomReceiverController extends RequestResponseController {
...
module.exports = (...args) => new CustomReceiverController(...args)
